...
Plese uniformly random initial velocity of ball v0 in range [0.5, 5.0], and sample initial height of ball randomly from normal distribution (mean = ![mean](https://imgur.com/vlt0FdX.jpg), std = ![std](https://imgur.com/6URUdBS.jpg))  
